...
int main(int argc, char *argv[])
{
    ...
    QCoreApplication::setOrganizationName("Beam");
    QCoreApplication::setOrganizationDomain("thefunctionary.com");
    QCoreApplication::setApplicationName("beam-view");
...
#endif
    {
        s_LoggerFile = new QFile(tempDir.filePath(QString("beam-view-%1.log").arg(QDateTime::currentSecsSinceEpoch())));
    ...
    QStringList existingLogNames = tempDir.entryList(QStringList("beam-view-*.log"), QDir::NoFilter, QDir::SortFlag::Time);
    ...
    SDL_SetHint(SDL_HINT_AUDIO_DEVICE_APP_NAME, "Beam");
    SDL_SetHint(SDL_HINT_APP_NAME, "Beam");
